...
export default class NewempdataWebPart
  extends BaseClientSideWebPart<INewempdataWebPartProps> {

  public render(): void {

    const element: React.ReactElement<INewempdataProps> =
      React.createElement(Newempdata, {
