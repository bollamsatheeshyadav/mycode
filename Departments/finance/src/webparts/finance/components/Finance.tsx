...
import type { IFinanceProps } from './IFinanceProps';
import { FaChevronDown } from "react-icons/fa"; 

export default class Finance extends React.Component<IFinanceProps> {
  ...
  public render(): React.ReactElement<IFinanceProps> {
    return (
