...
import type { ISecurityProps } from './ISecurityProps';
import { FaChevronDown } from "react-icons/fa";

export default class Security extends React.Component<ISecurityProps> {
   private buttons = [
  ...
  private menuItems = [
    {
      ...
      children: [
        ...
        { title: "SOL/SOD", url: "https://sf71.sharepoint.com/sites/DemoStarAir/Lists/Travel%20requests/AllItems.aspx?npsAction=createList&ovuser=13191850%2D9259%2D4961%2Da040%2Dae55d6dfb223%2Csatheesh%2Eb%40allianceproit%2Ecom&OR=Teams%2DHL&CT=1765910462153&clickparams=eyJBcHBOYW1lIjoiVGVhbXMtRGVza3RvcCIsIkFwcFZlcnNpb24iOiI0OS8yNTExMzAwMTMxMiIsIkhhc0ZlZGVyYXRlZFVzZXIiOmZhbHNlfQ%3D%3D" }
      ]
    }
  ];

  public render(): React.ReactElement<ISecurityProps> {
    return (
