...
import type { ILegalProps } from './ILegalProps';
import { FaChevronDown } from "react-icons/fa";

export default class Legal extends React.Component<ILegalProps> {
  private buttons = [
    { title: "Policy", url: "https://ghodawatent.sharepoint.com/sites/UATLegal/Policies/Forms/AllItems.aspx" },
    { title: "Procedure", url: "https://ghodawatent.sharepoint.com/sites/UATLegal/procedure/Forms/AllItems.aspx" },
    { title: "Process", url: "https://ghodawatent.sharepoint.com/sites/UATLegal/procedure/Forms/AllItems.aspx" },
